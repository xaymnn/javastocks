...
public class SuppressionArticleController {
    ...
    @FXML
    private Label afficheArticlevolume; // Label pour afficher le volume de l'article
    @FXML
        ...
        if (connection != null) {
            try {
                ...
                if (resultSet.next()) {
                    ...
                    afficheArticlevolume.setText(resultSet.getString("volume"));
