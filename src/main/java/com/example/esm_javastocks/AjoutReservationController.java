            ...
            try {
                ...
                if (connection != null) {
                    try {
                        ...
                        String maxIdQuery = "SELECT MAX(reservation_id) FROM reservation";
                        ...
                        String sql = "INSERT INTO reservation (reservation_id, date_reservation, coureur_id, type_epreuve_id, article_id, quantite_reservee) VALUES (?, ?, ?, ?, ?, ?)";
