...
public class TypesEpreuveController {


    @FXML
    protected void onAjouttypeepreuveButtonClick() {
        // Charger et afficher la page "Article en rupture / Réservation en attente"
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("ajout-type-epreuve.fxml"));
